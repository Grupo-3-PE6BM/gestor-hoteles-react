...
import { ListaTipoEvento } from "./tipo-evento/components/ListaTipoEvento"
import { CreateTipoEvento } from "./tipo-evento/components/AgregarTipoEvento"
  ...
  return (
    <>
      ...
      <Routes>
        ...
        {/* Agregar Tipo Evento */}
        <Route
          path="/agregarTipoEvento"
          element={acepta ? <CreateTipoEvento/> : <Navigate to="/login" />}
        ></Route>
